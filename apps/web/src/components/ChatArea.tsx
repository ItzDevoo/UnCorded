...
const ChatArea = () => {
  ...
  const isFileSharingBlocked = createMemo(() => isDm() || (isFreeUser() && isServerChannel()));
          ...
          <>
            ...
            <div class="flex min-h-0 flex-1">
              <FileDropZone
                ...
                disabledMessage={
                  isDm()
                    ? "Use the Send File button in the sidebar to share files"
                    : "Upgrade to Supporter to share files in servers"
                }
              >
