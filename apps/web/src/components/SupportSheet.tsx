...
const faqItems = [
  {
    ...
    answer:
      "Click 'Create Server' under Servers in the sidebar. Give it a name and you're ready to go.",
  },
  {
    id: "add-friends",
    question: "How do I add friends?",
    answer:
      "Go to Friends in the sidebar and use the Add Friend input at the top. Search by username and send a request.",
  },
  {
    id: "p2p-file-sharing",
    question: "How does P2P file sharing work?",
    answer:
      "Files are shared directly between users using WebTorrent. Click Send File in the sidebar, select a friend and file. No server storage needed.",
  },
  {
    id: "subscription-tiers",
    question: "What are the subscription tiers?",
    answer:
      "Supporter gives you unlimited servers, 100MB uploads, and file sharing in server channels. Server Owner adds server customization. Check Settings > Upgrade for full details.",
  },
  {
    id: "delete-account",
    question: "Can I delete my account?",
    answer:
      "Yes. Go to Settings > Account and scroll to the Danger Zone at the bottom. Account deletion is permanent and cannot be undone.",
  },
];
