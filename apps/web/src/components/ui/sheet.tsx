...
const SheetContent = (props: SheetContentProps) => {
  ...
  return (
    <Portal mount={document.body}>
      <div class="fixed inset-0 z-[--z-modal] flex" onClick={() => local.onClose?.()}>
        {/* Overlay */}
        ...
        <div
          ...
          aria-modal="true"
          class={cn(
            "relative h-full w-72 bg-sidebar",
            side() === "left"
              ? "fixed left-0 top-0 animate-slide-in-left"
              : "fixed right-0 top-0 animate-slide-in-right",
            local.class,
          )}
